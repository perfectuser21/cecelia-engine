...
# ========================================
if [[ "$DRY_RUN" != "true" ]]; then
    echo -e "${BLUE}[4] 写入部署证据${NC}"

    cd "$ENGINE_ROOT"
    STAMP_FILE="$TARGET_DIR/DEPLOY-STAMP"
